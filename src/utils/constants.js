export const ENTRY_TYPES = {
  food:       { label: 'Food',       color: '#6b9e6b', lightBg: '#edf5ed', dot: 'bg-food' },
...
export const MEMBER_COLORS = [
  ...
  { id: 'sky',    label: 'Sky',    hex: '#5b9ec9' },
  { id: 'violet', label: 'Violet', hex: '#9b76b5' },
  { id: 'amber',  label: 'Amber',  hex: '#c8956c' },
  { id: 'teal',   label: 'Teal',   hex: '#5aa89e' },
  { id: 'pink',   label: 'Pink',   hex: '#c97b9b' },
  { id: 'lime',   label: 'Lime',   hex: '#6b9e6b' },
  { id: 'indigo', label: 'Indigo', hex: '#7b8fb5' },
]
